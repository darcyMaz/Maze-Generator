...
6. Choose whether to spawn in the maze on start or call its public function from somewhere else using the boolean variable in the inspector.
7. Press play and see the square maze spawn in!
